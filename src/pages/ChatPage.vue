            ...
            >
              <div class="message-bubble">
                <div class="message-content">
                  <div
                    v-if="message.sender === 'assistant' && message.audioUrl"
                    class="audio-player"
                  >
        ...
        <q-card style="min-width: 300px">
          ...
          <q-card-section>
            <q-list>
              ...
              <q-item clickable v-close-popup @click="startNewConversation">
                <q-item-section avatar>
                  <q-icon name="add_comment" color="primary" />
                </q-item-section>
                <q-item-section>
                  <q-item-label>New Conversation</q-item-label>
                  <q-item-label caption>Start a fresh conversation</q-item-label>
                </q-item-section>
              </q-item>
